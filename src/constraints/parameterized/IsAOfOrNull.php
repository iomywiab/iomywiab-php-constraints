 ...
 *
 * File name....: IsAOfOrNull.php
 * File path....: C:/_GitLocal/iomywiab-php-constraints/src/constraints/parameterized/IsAOfOrNull.php
 * Class name...: IsAOfOrNull.php
 ...
 */
class IsAOfOrNull extends IsAOf
{
    /**
     * @inheritDoc
     */
    public static function isValid(string $className, $value, ?string $valueName = null, array &$errors = null): bool
    {
        ...
        if (null !== $errors) {
            $format = 'Instance of [%s] or its parents or null expected';
