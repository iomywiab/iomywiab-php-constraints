 ...
 *
 * File name....: IsValidArrayKeyOrNull.php
 * File path....: C:/_GitLocal/iomywiab-php-constraints/src/constraints/simple/IsValidArrayKeyOrNull.php
 * Class name...: IsValidArrayKeyOrNull.php
 ...
 */
class IsValidArrayKeyOrNull extends IsValidArrayKey
{
    /**
     * @inheritDoc
     */
