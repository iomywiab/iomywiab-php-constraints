 ...
 * File path....: C:/_GitLocal/iomywiab-php-constraints/tests/parameterized/IsLessOrEqualTest.php
 * Class name...: IsLessOrEqualTest.php
...
class IsLessOrEqualTest extends ConstraintTestCase
{
    ...
    public function testAssert(): void
    {
        ...
        try {
            IsLessOrEqual::assert(-2, -3);
            IsLessOrEqual::assert(-2, -2.01);
            IsLessOrEqual::assert(-2, -2);
        } catch (Exception $cause) {
            throw new Exception('Unexpected exception', 0, $cause);
        }
        IsLessOrEqual::assert(-3, -2);
    }
}