 ...
 * Last modified: 2022-05-05 23:31:37
 * Version......: v2
 */
...
class IsInstanceOfOrNullTest extends ConstraintTestCase
{
    ...
    public function __construct(
        ...
        $validSamples = [null, StandardTestValues::getException()];
        $testValues = new TestValues($validSamples, [new Error()]);

        parent::__construct(new IsInstanceOfOrNull(Exception::class), $testValues, false, $name, $data, $dataName);
    }
}
