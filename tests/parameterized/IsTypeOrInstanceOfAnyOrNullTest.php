 ...
 * Last modified: 2022-05-13 21:54:00
 * Version......: v2
 */
...
class IsTypeOrInstanceOfAnyOrNullTest extends ConstraintTestCase
{
    ...
    public function __construct(
        ...
        $constraint = new IsTypeOrInstanceOfAnyOrNull([IsType::INT, IsType::FLOAT], [LogicException::class]);
        $validSamples = [new LogicException(), null];
        $validSamples = StandardTestValues::makeUnion(
            $validSamples,
            StandardTestValues::get(StandardTestValues::FLOATS | StandardTestValues::INTEGERS)
        );
        $invalidSamples = ['x', true, false, [], StandardTestValues::getException()];
