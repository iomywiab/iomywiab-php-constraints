 ...
 * File path....: C:/_GitLocal/iomywiab-php-constraints/tests/simple/IsSigned8OrNullTest.php
 * Class name...: IsSigned8OrNullTest.php
...
class IsSigned8OrNullTest extends ConstraintTestCase
{
    ...
    public function testAssert(): void
    {
        ...
        try {
            IsSigned8OrNull::assert(-128);
            IsSigned8OrNull::assert(0);
            IsSigned8OrNull::assert(127);
            IsSigned8OrNull::assert(null);
