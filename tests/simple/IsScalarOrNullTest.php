 ...
 * Last modified: 2022-05-05 23:32:14
 * Version......: v2
 */
...
class IsScalarOrNullTest extends ConstraintTestCase
{
    ...
    public function __construct(
        ...
        $validSamples = StandardTestValues::get(StandardTestValues::NULLS | StandardTestValues::SCALARS);
        $testValues = new TestValues($validSamples, []);

        parent::__construct(new IsScalarOrNull(), $testValues, false, $name, $data, $dataName);
    }
}
