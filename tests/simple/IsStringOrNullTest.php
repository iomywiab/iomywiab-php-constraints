 ...
 * Last modified: 2022-05-05 23:31:57
 * Version......: v2
 */
...
class IsStringOrNullTest extends ConstraintTestCase
{
    ...
    public function __construct(
        ...
        $validSamples = StandardTestValues::get(StandardTestValues::NULLS | StandardTestValues::STRINGS);
        $testValues = new TestValues($validSamples, []);

        parent::__construct(new IsStringOrNull(), $testValues, false, $name, $data, $dataName);
    }
}
