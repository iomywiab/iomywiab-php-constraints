...
use iomywiab\iomywiab_php_constraints\constraints\simple\IsNumber;
...
/**
 */
class IsNumberTest extends ConstraintTestCase
{
    /**
     * @param mixed $name
     * @param array $data
    ...
    public function __construct(
        ...
        parent::__construct(new IsNumber(), $testValues, false, $name, $data, $dataName);
    }
}
