 ...
 * File path....: C:/_GitLocal/iomywiab-php-constraints/tests/simple/IsStringNotEmptyTest.php
 * Class name...: IsStringNotEmptyTest.php
...
class IsStringNotEmptyTest extends ConstraintTestCase
{
    ...
    public function testIsValid(): void
    {
        $this->checkConstraint(
            new IsStringNotEmpty(),
            ['abc', 'true', 'false', '-1', '0', '1'],
            []
        );
    }
    ...
    public function testAssert(): void
    {
        ...
        try {
            IsStringNotEmpty::assert('1');
            IsStringNotEmpty::assert('a');
        } catch (Exception $cause) {
            throw new Exception('Unexpected exception', 0, $cause);
        }
        IsStringNotEmpty::assert('');
    }
}