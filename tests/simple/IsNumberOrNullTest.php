 ...
 *
 * File name....: IsNumberOrNullTest.php
...
use iomywiab\iomywiab_php_constraints\constraints\simple\IsNumberOrNull;
...
/**
 */
class IsNumberOrNullTest extends ConstraintTestCase
{
    /**
     * @param mixed $name
     * @param array $data
    ...
    public function __construct(
        ...
        parent::__construct(new IsNumberOrNull(), $testValues, false, $name, $data, $dataName);
    }
}
