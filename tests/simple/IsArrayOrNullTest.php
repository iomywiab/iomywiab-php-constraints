...
class IsArrayOrNullTest extends ConstraintTestCase
{
    ...
    public function __construct(
        ...
        $validSamples = StandardTestValues::get(StandardTestValues::NULLS | StandardTestValues::ARRAYS);
        $testValues = new TestValues($validSamples, []);

        parent::__construct(new IsArrayOrNull(), $testValues, false, $name, $data, $dataName);
    }
}
