 ...
 * File path....: C:/_GitLocal/iomywiab-php-constraints/tests/simple/IsArrayNotEmptyTest.php
 * Class name...: IsArrayNotEmptyTest.php
...
class IsArrayNotEmptyTest extends ConstraintTestCase
{
    ...
    public function testAssert(): void
    {
        ...
        try {
            IsArrayNotEmpty::assert([1, 2, 3]);
        } catch (Exception $cause) {
            throw new Exception('Unexpected exception', 0, $cause);
        }
        IsArrayNotEmpty::assert([]);
    }
}