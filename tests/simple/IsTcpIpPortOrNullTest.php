 ...
 * Last modified: 2022-05-05 23:32:01
 * Version......: v2
 */
...
class IsTcpIpPortOrNullTest extends ConstraintTestCase
{
    ...
    public function __construct(
        ...
        $testValues = new TestValues([null, 0, 1, 65535], [65535 + 1]);

        parent::__construct(new IsTcpIpPortOrNull(), $testValues, false, $name, $data, $dataName);
    }
}
