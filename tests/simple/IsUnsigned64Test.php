 ...
 * File path....: C:/_GitLocal/iomywiab-php-constraints/tests/simple/IsUnsigned64Test.php
 * Class name...: IsUnsigned64Test.php
...
class IsUnsigned64Test extends ConstraintTestCase
{
    ...
    public function testAssert(): void
    {
        ...
        try {
            IsUnsigned64::assert(0);
            IsUnsigned64::assert(9223372036854775807);
        } catch (Exception $cause) {
            throw new Exception('Unexpected exception', 0, $cause);
        }
        IsUnsigned64::assert(9223372036854775807 + 1);
    }
}